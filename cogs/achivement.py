...
achievements = {
    ...
    "Lealista": {
        ...
        "requirement": lambda message: nextcord.utils.get(message.author.roles, name="Server Booster") is not None,
    },
...
user_progress = JSON.Read("json/user_progress.json")


messageCount = JSON.Read("json/messageCount.json")
...
class Achivements(commands.Cog, name="Achievements"):
    ...
    async def on_message(self, message):
        ...
        JSON.Write("json/messageCount.json", messageCount)
        ...
        for achievement in achievements:
            ...
            if str(message.author.id) not in user_progress:
                ...
                JSON.Write("json/user_progress.json", user_progress)
    ...
    async def progress(self, interaction: nextcord.Interaction):
        JSON.Read("json/user_progress.json")
        embed = nextcord.Embed(color=nextcord.Color.blue())
